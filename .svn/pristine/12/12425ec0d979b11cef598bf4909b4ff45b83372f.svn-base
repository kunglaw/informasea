...
<script src="<?=asset_url("plugin/cropper-master/main_resume.js")?>" ></script>
<?php
  ...
  $pr = $this->photo_mdl->get_photo_resume($username);
      ...
      <div class="modal-content">
          <form class="avatar-form" action="<?php echo base_url("photo/photo_crop/cropping");?>" enctype="multipart/form-data" method="post">
              <div class="modal-header bg-primary">
                  ...
                  <h4 class="modal-title" id="avatar-modal-label">Change Photo Resume </h4>
              </div>
              <div class="modal-body">
                  <div class="avatar-body">
                      ...
                      <div class="avatar-upload" style="width:100%">
                      	<input class="form-control" name="photo_type" value="resume" type="hidden">
                        <input type="hidden" name="crop_width"  value="100" />
                        <input type="hidden" name="crop_height" value="133" />
                        <input class="form-control nama_gambar" name="nama_gambar" value="<?=$pr['nama_gambar']?>" type="hidden" />
                      ...
                      <div class="row">
                          <div class="col-md-9">
                              <div class="avatar-wrapper">
                              	<img src="<?php echo img_url("photo/$username/resume/$pr[nama_gambar]");?>" alt="Picture"/>
                              </div>
                          </div>
                          <div class="col-md-3">
