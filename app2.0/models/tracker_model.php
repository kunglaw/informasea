...
class Tracker_model extends CI_Model {
    ...
    public function save_seatizen_action($seatizen_id, $action) {
		...
		$pelaut = $this->user_model->get_detail_pelaut_byid($seatizen_id);
    ...
    public function save_agentsea_action($agentsea_id, $action) {
		...
		$nama_perusahaan = empty($company['nama_perusahaan']) || $company['nama_perusahaan'] == null ? '':$company['nama_perusahaan'];
    ...
    public function save_vacantsea_visitor($seatizen_id, $vacantsea_id) {
		...
		$vacant = $this->vacantsea_model->get_vacantsea_id($vacantsea_id);
...

	{
	   ...
	   function history_editpassword($seatizen_id){
	...
	function track_print_resume($action)
	{		
    ...
    function history_editusername($seatizen_id){
