...
if(!function_exists('e_vision'))
{
	function e_vision($value)
	{
		
		$default = "<p> - Vision is not defined </p>";
...
if(!function_exists('e_mision'))
{
	function e_mision($value)
	{
		
		$default = "<p> - Mision is not defined </p>";
