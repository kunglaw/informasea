...
function simple_php_captcha($config = array()) {
    ...
    $bg_path = dirname(__FILE__) . '/captcha_master/backgrounds/';
    $font_path = dirname(__FILE__) . '/captcha_master/fonts/';
    ...
    if ( strpos($_SERVER['SCRIPT_FILENAME'], $_SERVER['DOCUMENT_ROOT']) ) {
		...
		$image_src = base_url("test/run_captcha").'?_CAPTCHA&amp;t=' . urlencode(microtime());
