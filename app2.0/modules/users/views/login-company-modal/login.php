...
<section class="content container-fluid">
    <div class="row">
        ...
        <div class="col-md-6 text-white m-t-1">
            ...
            <form class="transparent register-form" role="form" 
            action="<?=base_url("users/company_process/agentsea_login_modal_process")?>" 
            method="post" >
               <?php
              ...
              <?php } ?>
                ...
                <input type="hidden" value="<?=!empty($_GET['t']) ? $_GET['t'] : 0 ?>" name="t" />
				...
				?>
                    ...
                    <input type="text" class="form-control" id="username_lg" name="username_lg" value="" >
                <?php
					}
				?>
                </div>
