...
border:1px solid black; ">
    ...
    ">
        ...
        <div style="line-height:20px">
            ...
            <p>To edit username or password, go to your <a href="<?=base_url("profile/$username/account")?>">account page</a></p>
            <p> Didn't sign up at Informasea ? <a href="<?php echo base_url("users/users_process/cancel_account/?username=$username")?>">click here to cancel this account</a> </p>
        </div>
    ...
    padding:10px 20px 10px 20px; display:block">
        ...
        <a href="<?=base_url("our-policy")?>">Privacy Policy</a> </b>
