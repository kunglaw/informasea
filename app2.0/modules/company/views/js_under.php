...
<script type="text/javascript">
        ...
        function getAllNation(){
            $.ajax({
                url:"<?php echo base_url("company/list_nation") ?>",
                type:"POST",
                success:function(data){
                    $("#list-nationality").html(data);
                }
            })
        }
    ...
    $(document).ready(function(){ 
     ...
     $("#frm-search-agentsea").submit(function(e){
       // alert('tes');
                    e.preventDefault();

        var keyword = $("#list-keyword").val();
        var nationality = $("#list-nationality").val();
        var url  = "<?php echo base_url('company/search');?>";
        if(keyword != ""){
            url+="/"+keyword+"/";
        }
...
//     window.location = '<?php echo $dest_page ?>'+num;
    // $.ajax({
...
// //     var keyword     = $("#list-keyword").val();
// //     var nationality = $("#list-nationality").val();
// //     var url         = "<?=base_url('agentsea/search');?>";
