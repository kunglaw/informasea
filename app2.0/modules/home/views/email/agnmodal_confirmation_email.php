...
border:1px solid black; ">
    ...
    ">
        ...
        <div style="line-height:10px">
        	<!-- text -->
        	<div> <h3> Informasea helps you to find your qualified crew from our seatizen database.</h3> </div>
        ...
        <div>
            ...
            <a href="mailto:<?=$config["smtp_user"]?>" style="text-decoration:none"><?=$config["smtp_user"]?></a>
            
            <p>This Email was sent to <b><?=$email_to?></b> from 
            <b style=""><a href="mailto:<?=$config["smtp_user"]?>" style="text-decoration:none"><?=$config["smtp_user"]?></a></b> 
            in accordance with 
