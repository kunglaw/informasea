<ul class="nav navbar-nav navbar-right">
                    ...
                    <form role="form" class="form-bootstrap" action="<?=base_url("users/users_process/login_universal")?>" method="post" >
                       ...
                       <div class="form-group"> 	 
                        ...
                        <div class="form-group">
                          ...
                          style="text-decoration:underline !important; color:#03F !important"><?=$this->lang->line("forgot")?> Password ? </a>
                        </div>
   ...
   <li class=""><a href="<?=base_url("users/register")?>"><?=strtoupper($this->lang->line("register"))?></a></li>
   <?php
