...
<div class="social">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        	<ul class="nav navbar-nav navbar-left">
                ...
                <?php } ?>
            	<li class=""><a href="<?=base_url("vacantsea")?>"><?=strtoupper($this->lang->line("vacantsea"))?></a></li>
                <li class=""><a href="<?=base_url("seatizen")?>"><?=strtoupper($this->lang->line("seatizen"))?></a></li>
                <li class=""><a href="<?=base_url("agentsea")?>"><?=strtoupper($this->lang->line("agentsea"))?></a></li>
            </ul>
