                        ...
                        <div class="item active">
                         <div class="text-box">
                           ...
                           <p align="center" class="">
                           	<input type="button" value="CREATE VACANTSEA FOR FREE" style="" onClick="quick_vacantsea()" class="btn btn-lg btn-huge btn-block text-white">
                           </p>
          ...
          <div class="container-fluid block">
              <div class="row">
                ...
                <form class="search-form text-white form-inline-custom" role="form" id="frm-search-dashboard">
                    <div class="form-group col-lg-3 col-md-10 col-sm-10 col-xs-10">
                ...
                <img src="<?=asset_url("img/shadow-search-landingpage.png")?>" style="" >
