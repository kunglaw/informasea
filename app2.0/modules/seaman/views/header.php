...
<?php
	...
	//print_r($ss);
	$url_cover	   = img_url("photo/$username/cover/$ss[0].".$ss[1]);
	$url_cover_thumb = img_url("photo/$username/cover/$ss[0]"."_thumb.".$ss[1]);
	
	if(empty($cover))
	{
		$url_cover = asset_url("img/img_ship.png");
		$url_cover_thumb = asset_url("img/img_ship.png");
	}
...
// echo "saya di folder seaman luar";
?>
...
<div id="profile-header" style="background-image:url(<?php echo $url_cover_thumb ?>); background-repeat:no-repeat; background-size:cover">
    ...
    <div class="media" style="z-index:10">
        ...
        <a class="pull-left" href="#" onclick="javascript:profile_crop_modal()" title="Click the Image to Change the Profile Photo">
            <img class="media-object" src="<?php echo $url; ?>" alt="Image" style="background-color:#FFF">
        </a>
