<?php //error_reporting(E_ALL) //experience, page experience, profile, module user ?>
...
?>
<script>
	function update_recommendation(id_recommendation)
	{
	
		$.ajax({
			  
			  type:"POST",
			  url:"<?=base_url("seaman/recommendation/update_recommendation")?>",
			  data:"username=<?=$this->uri->segment(2)?>&id_recommendation="+id_recommendation,
			  success: function(dt)
			  {
				  $("#recommendation-temp").html("");
...
<div class="box">
  ...
  <div class="box-header">
      ...
      <h4 class="box-heading header-text">Recommendation 
      	...
      	<button id="add-reccomendation" class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal"> <b>Add Recommendation</b> </button>
        <?php } ?>
      </h4>
              ...
              <div class="col-md-11">
                  ...
                  <div class="popover right">
                    ...
                    <h3 class="popover-title">
                      ...
                      <?php if($this->session->userdata("id_user") == $rowa["id_pelaut_sender"]){ ?>
                      <button class="btn btn-primary btn-sm" 
                      onClick="update_recommendation(<?=$rowa["id_recommendation"]?>)" id="edit-btn-1" type="button" >
              ...
              <div class="col-md-11">
                  ...
                  <div class="popover right">
                    ...
                    <h3 class="popover-title">
                      ...
                      <div class="pull-right" style="z-index:1 !important"> 
                      <?php if($user_type != "" && ($id_user == $rowb["id_pelaut_sender"] || $id_perusahaan == $rowb["id_perusahaan"])){ ?>
                      <button class="btn btn-primary btn-sm" 
                      onClick="update_recommendation(<?=$rowb["id_recommendation"]?>)" id="edit-btn-1" type="button" >
                      	<i class="glyphicon glyphicon-pencil"></i>
                      </button>
                      <?php } ?>
                      </div>
...
<script>
	...
	$("#add-reccomendation").click(function(){
		
		var type_user_sess = "<?=$this->session->userdata("type_user")?>";
		if(type_user_sess != "")
		{
		  ...
		  $.ajax({
			  ...
			  type:"POST",
			  url:"<?=base_url("seaman/recommendation/add_recommendation")?>",
