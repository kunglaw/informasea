...
border:1px solid black; ">
    ...
    ">
      <!-- body -->
        <center> <h2 style="font-size:36px; color:red"> Primary email has changed </h2> </center>
        ...
        <div style="line-height:20px">
          ...
          <div> <h2> 
            Your primary email address was changed from <?=$email_lama;?> to <?=$email_baru;?> on <?php echo $date;?>
