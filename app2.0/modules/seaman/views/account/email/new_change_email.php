...
border:1px solid black; ">
    ...
    ">
      <!-- body -->
        <center> <h2 style="font-size:36px; color:red"> New email has added </h2> </center>
    
        <div style="line-height:20px">
          <!-- text -->
          <h2> Hi <?=$this->session->userdata('username'); ?> </h2>

          <div> <h2> The email address <?php echo $email_baru;?> was added to your informasea account on 
            <?php echo $date;?> 
          </h2> 
