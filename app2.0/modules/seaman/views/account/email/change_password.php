...
border:1px solid black; ">
    ...
    ">
      <!-- body -->
        <center> <h2 style="font-size:36px; color:red"> Your Password Changed !</h2> </center>
    
        <div style="line-height:20px">
          <!-- text -->
          <h2> Hi <?=$this->session->userdata('username'); ?> </h2>

          <div> <h2> The password for your informasea account : http://informasea.com/<?=$this->session->userdata('username'); ?> was 
          recently changed.</h2> 
