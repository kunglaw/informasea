 <script src="<?=asset_url("plugin/tinymce/tinymce.min.js")?>"></script>
...
<script>
...

	{
		...
		$.ajax({
			...
			url 	  : '<?php echo base_url("seaman/resume_process/update_cover_letter_process"); ?>',
  ...
  <div class="modal-dialog modal-lg"><!-- large -->
    ...
    <div class="modal-content"> 
    	...
    	<div class="modal-header bg-primary" style="padding:-20px 0 -20px 0">
        	...
        	<h4> <?=$this->lang->line("edit")?> Cover Letter <!-- Certificate of cover-letter --> <button type="button" id="close-modal-btn" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></h4>
            ...
            <div id="form-cover-letter">
            	...
            	<form role="form" class="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="cover_letter" id="cover_letter" rows="10" style=""><?=htmlspecialchars_decode(html_entity_decode($pelaut["cover_letter"]))?></textarea>
