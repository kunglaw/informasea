  ...
  <div class="modal-dialog modal-md"><!-- large -->
    <div class="modal-content"> 
        <div class="modal-header bg-primary" style="padding:-20px 0 -20px 0">
            <h4> <?=$this->lang->line("edit")?>  Profile <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></h4> 
        </div><!-- modal-header -->
        <div class="modal-body">
			...
			<script>
                function submit_kepelautan()
				{
					...
					$.ajax({
						...
						type:"POST",
						url:"<?php echo base_url("seaman/resume_process/edit_kepelautan_process"); ?>",
            ...
            <form id="form-edit-kepelautan" role="form" method="post">
              <div class="" style="margin:0 0 0 0;">
                  ...
                  <div class="form-group" style="width:80%">
                      <label for="last_education" class="row container"><?=$this->lang->line("expected_salary")?> </label>
                      ...
                      <div class="" style="">
                        ...
                        <div class=" pull-left"  style="width:40%">
                            <input type="text" name="expected_sallary" id="expected_sallary" class="form-control" 
                            value="<?php echo $profile['expected_sallary'] ?>" placeholder="sallary..." />
                        </div>
                  ...
                  <div class="form-group">
                  	...
                  	<button class="btn btn-warning pull-left" onclick="call_report_form()" type="button" data-loading-text="Loading..."> &nbsp; 
                        ...
                        <button class="btn btn-danger pull-right" data-dismiss="modal"> <span class="glyphicon glyphicon-remove-circle">
                        </span>&nbsp; <b> <?=$this->lang->line("cancel")?>  </b> </button>
                        <span class="pull-right">&nbsp;</span>
                        <button class="btn btn-success pull-right" id="save-kepelautan-btn" type="button" data-loading-text="Loading..."> 
