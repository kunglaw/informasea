<div class="data-table-document">
        <div ><h3>  <?=$this->lang->line("document_medical")?> </h3></div>
        
        <div class="clearfix"></div>    
        
        <h5> <?=$this->lang->line("document_record")?> <button class="btn btn-filled btn-sm pull-right" id="document-btn" modal="form-add-document"> 
        ...
        <table class="table table-bordered hover">
         ...
         <h5> Visa <button class="btn btn-filled btn-sm pull-right" id="visa_btn" id_pelaut="<?php echo $document[0]['pelaut_id'] ?>" modal="form-add-visa"> <span class="glyphicon glyphicon-plus"> </span> <?=$this->lang->line("add")?> </button>
          <br /> </h5>
          ...
          <h5> <?=$this->lang->line("medical_record")?> <button class="btn btn-filled btn-sm pull-right" id="medical-btn" id_pelaut="<?php echo $document[0]['pelaut_id'] ?>" modal="form-add-medical"><span class="glyphicon glyphicon-plus"></span> <?=$this->lang->line("add")?> </button>
          <br> </h5> 
