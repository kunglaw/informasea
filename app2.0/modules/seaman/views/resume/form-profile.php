  ...
  <div class="modal-dialog modal-lg"><!-- large -->
    <div class="modal-content"> 
        <div class="modal-header bg-primary" style="padding:-20px 0 -20px 0">
            <h4> <?=$this->lang->line("edit")?> Profile 
              ...
              <div id="tampung_error"></div>
                ...
                <div class="pull-left" style="margin:0 0 0 20px; width:30%">
                    ...
                    <label for="marrital_status">
                      <?=$this->lang->line("marrital_status")?> 
                    </label>
                    <div>
                    <?php
                    ...
                    <input type="radio" name="marrital_status" id="single" value="single" <?php echo $checked_singel ?>> 
                    	&nbsp; <span class=""> <?=$this->lang->line("singel")?> </span> </label>&nbsp;
                    
                    <label for="married"  class="radio-inline">
                    <input type="radio" name="marrital_status" id="married" value="married" <?php echo $checked_married ?>> 
                    	&nbsp; <span class=""> <?=$this->lang->line("married")?>  </span> </label>
                ...
                <button class="btn btn-success pull-right" type="button" id="save-profile-btn"><span class="glyphicon glyphicon-floppy-disk">
                </span>&nbsp;<b><?=$this->lang->line("save")?> </b> </button>
                
                <button class="btn btn-warning pull-left" type="button" onclick="call_report_form()"><span class=""></span>&nbsp;<b>
                <?=$this->lang->line("report_problem")?> </b> </button>
                <span class="clearfix"></span>
                </form>
