  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body "> 
      	...
      	<?=$this->lang->line("delete_confirmation_text")?>  "<strong><?php echo $document["type"]; ?></strong>" item ?         
      ...
      <div class="modal-footer">  
         ...
         <button type="button" class="btn btn-danger btn-sm pull-right" data-dismiss="modal" id="no-btn">
              <?=$this->lang->line("no")?>
          </button>

        	<span style="margin:5px" class="pull-right"></span>

          <button type="button" class="btn btn-primary btn-sm pull-right" id="yes-btn" > 
         	  <?=$this->lang->line("yes")?>
          </button>
...
<script>
...

	{
		...
		$.ajax({
			...
			url:"<?php echo base_url("seaman/resume_process/delete_document_process") ?>",
