          ...
          <div id="form-profile">
            ...
            <script>
              ...
              <div id="tampung_error"></div>
                ...
                <button class="btn btn-success pull-right" type="button" id="save-profile-btn"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;<b>Save</b> </button>
                
                <button class="btn btn-warning pull-left" type="button" onclick="call_report_form()"><span class=""></span>&nbsp;<b>Report Problem</b> </button>
                <span class="clearfix"></span>
