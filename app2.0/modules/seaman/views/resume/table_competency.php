<div id="data-table-competency" class="jarak">
        ...
        <div>
            ...
            <h3> COC and Endorsement </h3> <span> <?=$this->lang->line("coc_privacy_text")?> </span>

            

            <button class="pull-right btn btn-filled btn-sm" id="coc-btn" modal="form-add-competency">

                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;<?=$this->lang->line("add")?>
        ...
        <table class="table table-bordered hover">
            ...
            <th>
                ...
                <?=$this->lang->line("certificate_of_competency")?>
