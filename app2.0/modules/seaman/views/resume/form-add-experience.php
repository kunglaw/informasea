  ...
  <div class="modal-dialog"><!-- large -->
    ...
    <div class="modal-content"> 
    	...
    	<div class="modal-header bg-primary" style="padding:-20px 0 -20px 0">
        	...
        	<h4> <?=$this->lang->line("add")?> <?=$this->lang->line("sea_service_record")?>  <button type="button" class="close" id="close-modal-btn" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></h4>
        	...
        	<form>                
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="" title="" name="periode_from" id="periode_from" data-id="periode_from" class="form-control" style="width:80%; background-color: white;" 
                    readonly >
            	...
            	<div class="form-group">
                    ...
                    <input type="" title="" name="periode_to" id="periode_to" data-id="periode_to" class="form-control" style="width:80%; background-color: white;" readonly >
