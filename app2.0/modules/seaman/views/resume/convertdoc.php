...
<body>
  <div class="wrapper">
    ...
    <section class="ab" style="position:relative; border-top:1px solid black;
    padding:1px;margin:-1% 1%;">
      <div class="row ab">
        <div class="col-xs-12">
          <span class="pull-left" style="float:left;"> Informasea.com </span>
          <span style="float:right;"><?php $today = getdate(); echo $today['year'] ?></span>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">  
            <h2 class="judul"><u> CURRICULUM VITAE </u> </h1>
            <table class="table table-bordered" style="width:100%;">
                <tr>
                  <td width="40%"> Name / Gender </td>
                  <td width="75%"><b> <?php echo $pelaut['nama_depan']." ".$pelaut['nama_belakang']; ?> </b> / <?php echo $pelaut['gender']; ?> </td>
  ...
  echo "";
      ...
      ?>
        <tr>
         ...
         <?php /* <td><?php echo //date_format_str($row2['date_issue']); ?></td> */ ?>
