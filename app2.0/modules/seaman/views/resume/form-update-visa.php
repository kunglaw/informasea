  ...
  <div class="modal-dialog"><!-- large -->
    <div class="modal-content"> 
    	<div class="modal-header bg-primary" style="padding:-20px 0 -20px 0">
        	...
        	<h4> <?=$this->lang->line("edit")?> Visa <button type="button" class="close" id="close-modal-btn" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></h4>
        	...
        	<form>                
               ...
               <?php    	} ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" title="" value="<?php echo date_picker_format($visa['date_issued']); ?>" name="date_issued" id="date_issued" class="form-control" style="width:80%; background-color: white" readonly autocomplete="off" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" title="" value="<?php echo date_picker_format($visa['date_expired']); ?>" name="date_expired" id="date_expired" class="form-control" style="width:80%; background-color: white" readonly autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <a class="label label-default" title="upload new attachment" onClick="$('#attachment').click()">&nbsp;<?=$this->lang->line("edit")?>&nbsp;</a>
                    &nbsp;
                ...
                <button class="btn btn-success pull-right" id="update-visa-btn" type="button" data-loading-text="Loading..."> 
