  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body "> 
      	 ...
      	 <?=$this->lang->line("delete_confirmation_text")?> "<strong><?php echo $competency["grade_license"]; ?></strong>" item ?         
...
<script>
...

	{
		...
		$.ajax({
			...
			url:"<?php echo base_url("seaman/resume_process/delete_competency_process") ?>",
