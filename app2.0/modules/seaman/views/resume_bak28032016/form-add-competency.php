  ...
  <div class="modal-dialog "><!-- large -->
    <div class="modal-content"> 
    	<div class="modal-header bg-primary" style="padding:-20px 0 -20px 0">
        	<h4> Add COC and Endorsement <!-- Certificate of Competency --> <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></h4>
            ...
            <div id="form-add-competency">
            	<form role="form" class="" method="post">
                   ...
                   <!--  <div class="form-group">
                     ...
                     <button class="btn btn-success" id="save-competency-btn" type="button" data-loading-text="Loading..."> <span class="glyphicon glyphicon-floppy-disk"></span>&nbsp; Save </button>
