        	...
        	<form>                
                <div class="form-group">
                    ...
                    <?php         
                        ...
                        ?>
                        <br>
                        <input type="text" name="national" value="<?php echo $user['kebangsaan']; ?>"  class="form-control" style="width:80%" readonly="readonly"> 
                        <?php
                        } else {
                        ?>
                        <input type="text" name="national" value="<?php echo $document['country']; ?>" class="form-control" style="width:80%;" readonly="readonly">
                        <?php
                        } ?> 
