...
<body>
  <div class="wrapper">
    ...
    <section style="position:relative;background:none repeat scroll 0% 0% #FFF; border:1px solid #F4F4F4;
    padding:1px;margin:1% 5%;">
      <div class="row">
        <div class="col-xs-12">
           <h2 class="page-header">
          <i class="fa fa-globe"></i> Informasea, Inc.
          <small class="pull-right" style="float:right;">Date: <?php $today = getdate(); echo $today['weekday'].', '.$today['month'].' '.$today['mday'].', '.$today['year'] ?></small>
          </h2>
        </div>
      </div>
        ...
        <div class="col-xs-12 table-responsive">  
            ...
            <table class="table table-bordered" style="width:100%;" border="2">
                <tr>
                  ...
                  <td width="70%"><b> <?php echo $pelaut['nama_depan']." ".$pelaut['nama_belakang']; ?> </b> / <?php echo $pelaut['gender']; ?> </td>
                  <td width="100%" rowspan="5" valign="middle">
      ...
      $this->load->model('photo/photo_mdl');
            ...
            ?>       
           <img src="<?=$url?>" alt="ini poto" style="width:113px;height:151px;" width="113" height="151">
         </div>
         <div id=""> </div>
       </td>
      </tr>
      ...
      <td> <?php echo $pelaut['tempat_lahir']." / ".$pelaut['tanggal_lahir']; ?> </td>
      </tr>
      <tr>
      <td> Religion </td>
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
            <h2> Document and Medical Record </h2>
            <br>
            <h3> Document </h3>
            <table class="example2 table table-bordered" border="1">
              <thead>
                <tr align="center">
                  <th> Type </th>
                  <th> Number </th>
