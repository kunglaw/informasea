...
class resume_ajax extends MX_Controller{
...

	{
		...
		$this->load->view("include/modal-report", $data);
...

	{
...

		{
		  ...
		  else if($modal_type == "form-edit-cover-letter")
		  {
			  ...
			  $this->load->view("resume/form-update-cover-letter",$data);
...

		  {
			  ...
			  $this->load->view("resume/form-edit-describe",$data);
