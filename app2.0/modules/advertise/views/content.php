        ...
        <form role="form" action="" method="post" class="registration-form" >
        	<fieldset>
                ...
                <div class="form-bottom">
                    ...
                    <!-- <div class="form-group">
                    	<label for="ad_page">Ad page</label>
                        <select name="ad_page" id="ad_page" class="form-control" >
                        	<option value="" selected disabled>- Select Page -</option>
                        	<?php foreach($ad_page as $row){ ?>
                            	<option value="<?=$row["id_page"]?>"><?=$row["page"]?> - <?=$row['currency']." ".number_format($row["price"])?></option>
                            <?php } ?>
                        </select>
                    </div> -->
