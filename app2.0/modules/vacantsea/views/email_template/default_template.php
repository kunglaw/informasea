...
border:1px solid black; ">
    ...
    ">
        ...
        <div>
            ...
            <b><a href="mailto:<?=$config["smtp_user"]?>" style="text-decoration:none" target="_blank"><?=$config["smtp_user"]?></a></b> 
            in accordance with 
            <a href="<?=base_url("our-policy")?>" style="text-decoration:none" target="_blank">our policy</a> </p>
    ...
    padding:10px 20px 10px 20px; display:block">
        ...
        <b style="float:left"> <a href="<?=base_url("about")?>" style="text-decoration:none" target="_blank"> About </a> | 
        <a href="<?=base_url("our-policy")?>" style="text-decoration:none" target="_blank"> Privacy Policy </a> </b>
