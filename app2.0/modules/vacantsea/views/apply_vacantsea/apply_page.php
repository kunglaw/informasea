                ...
                <div class="table-responsive col-md-6 row">
                    ...
                    <table class="table table-stripped ">
                        ...
                        <tr>
                            ...
                            <td><?=$this->lang->line("vessel_type")?></td>
                        ...
                        <tr>
                            ...
                            <td><?=$this->lang->line("navigation_area")?></td>
                ...
                <div id="profil" class="col-md-12">
                    ...
                    <form method="post" class="" id="form-apply">
					  ...
					  you are already applied this vacantsea, if you're update your resume and applied back this vacantsea, please continue
                        ...
                        <p><?=$this->lang->line("promote_explain")?></p>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="">
                                        ...
                                        <div><a href="<?php echo base_url("seaman/resume"); ?>" target="new"> <?=$this->lang->line("view")?> Resume</a> </div>
                                    ...
                                    <p><?=$this->lang->line("expected_salary")?> : <?php echo $profile_resume['exp_sallary_curr'] ?> <?php echo number_format($profile_resume['expected_sallary']); ?>  </p>
