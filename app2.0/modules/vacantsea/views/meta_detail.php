...
<link rel="alternate" 	 hreflang="id" href="<?=base_url("vacantsea")?>" />
<link rel="canonical" 	 href="<?php echo base_url("vacantsea") ?>" />
...
<?php
	...
	$md .= "agentsea:$company[nama_perusahaan] ,";
	$md .= "title:$vacantsea[vacantsea]		,";
	$md .= "department:$department[department] ,";
	$md .= "rank:$rank[rank]					,";
	$md .= "ship type:$ship_type[ship_type]	,";
	$md .= "ship:$ship[ship_name]				 ";
...
<meta property="og:title"         content="<?=$company['nama_perusahaan']." - ".$title?>" />
<meta property="og:description"   content="<?php echo $vacantsea['description']; ?>" />
