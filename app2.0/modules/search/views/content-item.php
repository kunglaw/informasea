...
<?php if(!empty($seatizen)) {
    ...
    $flag = base_url()."assets/flags/$flag_name";
   ...
   $b = $a[0]."_thumb.".$a[1];
    ...
    $path_img = img_url("photo/".$row['username']."/profile_pic/".$b);
		...
		$path_img = base_url()."assets/img/user.jpg";
	}
   ...
   <div class="col-md-<?php echo $col; ?> seatizen-item-container">
    <div class="media  <?php echo ($col == 1) ? 'box' : 'seatizen-item'; ?>" style="min-height:210px;">
        ...
        <div class="media-body">
            ...
            <div class="subtitle text-link seatizen-role">  <i class="fa fa-certificate"></i> <?php echo $rank['rank']; ?></div>
            <?php } ?>
            ...
            </span><span style="float:left"> <?=$row['kebangsaan'] ?></span> 
            </div>
