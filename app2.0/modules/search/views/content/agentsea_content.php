<?php
    ...
    $detail_comp        = $this->company_model->get_detail_company($id_perusahaan);
	$nationality        = $this->nation_model->get_detail_nationality($detail_comp['id_nationality']);
	...
	$des_comp           = !empty($detail_comp['description']) ? word_limiter($detail_comp['description'],200) : "There is no description";
    $name_company       = $detail_comp["nama_perusahaan"];
    $username_comp      = $detail_comp["username"];
    $logo_img           = $this->company_model->get_logoimage('username_comp');
