...
*/
define("BASE_URL","http://localhost/informasea");
define("ASSET_URL","http://localhost/informasea_assets");
...
define("URL_WEBSITE","http://www.informasea.com");
...
/* define("PROFILE_PELAUT",base_url("seaman/resume"));
define("PROFILE_AGENTSEA","");

define("MENU_AGENTSEA",base_url("agentsea"));
define("MENU_VACANTSEA",base_url("vacantsea"));
define("MENU_SEATIZEN",base_url("seatizen"));*/
...
define("DEFAULT_IMG_PROFILE_SEAMAN",ASSET_URL."/img/ic_landing_seaman.svg");
define("DEFAULT_IMG_RESUME_SEAMAN",ASSET_URL."/img/ic_landing_seaman.svg");

define("DEFAULT_IMG_LOGO_AGENTSEA",ASSET_URL."/img/ic_landing_company.svg");
define("DEFAULT_IMG_PROFILE_MANAGER",ASSET_URL."/img/ic_landing_company.svg");
define("DEFAULT_IMG_PROFILE_AGENT",ASSET_URL."/img/ic_landing_company.svg");
...
define("DEFAULT_IMG_COVER_AGENT",ASSET_URL."/img/img_bg_landing.png");
