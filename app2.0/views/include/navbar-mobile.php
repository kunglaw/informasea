    ...
    <div class="container-fluid">
        <div class="navbar-header">
              ...
              <div class="navbar-brand">
                  ...
                  <img src="<?=asset_url("img/img_logo_mobile.png")?>" alt="logo">
                </a>
              </div>
            ...
            <ul class="nav-mobile pull-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-blue" role="menu">
                        <?php if(!empty($user)) { ?>
                          <li>
                          		<a href="<?=base_url("seaman/resume"); ?>">
                                	<img class="icon" src="<?=asset_url("img/ic_profile.svg")?>"> <?=$this->lang->line("my_profile")?>
                                </a>
                          </li>
                        <!--   <li>
                        ...
                        <li><a href="<?php echo base_url('infr-policy');?>"><?=$this->lang->line("privacy")?></a></li>

                        <li><a href="<?php echo base_url('contact');?>"><?=$this->lang->line("contact_us")?></a></li>
