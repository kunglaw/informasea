       ...
       <div class="block-home">   
          ...
          ?>
            ...
            <ul class="nav navbar-nav navbar-right" style="">
                      ...
                      <div class="">
                          <form role="form" class="" action="<?=base_url("users/users_process/login_universal")?>" method="post">
                             ...
                             <div class="form-group"> 	 
                              ...
                              <div class="form-group">
                			  	  <input name="remember_me" id="remember_me" value="0" class="" type="checkbox"> &nbsp; <?=$this->lang->line("remember")?> 
                                  <?=$this->lang->line("me")?>
                			  </div>
                              <div class="form-group">
                              	<a href="https://www.informasea.com/users/forgotpass" class=" text-link"><?=$this->lang->line("forgot")?> Password ? </a>
                              </div>        
                              <button class="btn btn-login form-control" type="submit" title="Login by Informasea">
                                  <span class="text-white">Log In</span>
                              </button>
                              
                              <span><hr style="margin-bottom:10px !important"></span>
                              
                              <p class="" align="center"> <?=$this->lang->line("or")?> Login <?=$this->lang->line("with")?> : </p>
                              ...
                              <button type="button" class="btn btn-google form-control" id="btn-google-login" 
                ...
                <li class="pull-left dropdown" style="margin:0 5px 0 0">
                   <a href="<?=base_url("users/register_all")?>"> <?=strtoupper($this->lang->line("register"))?> </a>
                </li>
...
<?php if($this->uri->segment(1) == "vacantsea"){
    ...
    ?>
            <ul class="nav navbar-nav navbar-left">
                <li class="<?=$activenih;?>"><a href="<?= base_url("vacantsea"); ?>"><?=strtoupper($this->lang->line("vacantsea"))?></a></li>
                <li class="<?=$activenih_s;?>"><a href="<?= base_url("seatizen"); ?>"><?=strtoupper($this->lang->line("seatizen"))?></a></li>
                <li class="<?=$activenih_c;?>"><a href="<?= base_url("agentsea"); ?>"><?=strtoupper($this->lang->line("agentsea"))?></a></li>
