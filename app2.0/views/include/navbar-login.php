          ...
          <div class="collapse navbar-collapse" id="mobile-menu">
              ...
              <ul class="nav navbar-nav main-menu text-white hidden-md hidden-sm">
                ...
                <!--   <li>
                  ...
                  <li><a href="<?=base_url("agentsea");?>"><span class="nav-sprite text-center" aria-hidden="true"></span>
              ...
              <!-- <form role="search" class="navbar-form navbar-search-form navbar-left" action="<?=base_url("search")?>" method="get">
                  ...
                  <div class="input-group">
                      ...
                      <input type="text" class=" search-query form-control" placeholder="<?=$this->lang->line("search")?> Informasea" name="keyword" id="keyword"/>
