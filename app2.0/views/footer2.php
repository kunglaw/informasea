<style>
	...
	#footer-baru .sosmed-list .helper {
    ...
    <div class="container-fluid">
        ...
        <div id="footer-left" class="col-md-6 col-sm-10">
            ...
            <div class="row" style="">
              ...
              <img src="<?=LOGO_INFORMASEA_WHITE?>" style="width:300px;" class="logo-white" alt="">
            ...
            <div class="row">
                ...
                <div class="col-md-1 col-sm-2 col-xs-2 sosmed-list">
                    <a href="https://plus.google.com/+informasea" target="_blank">
                        <span class="helper"><img src="<?=asset_url("img/logo_sosmed/google_plus_button.png")?>" class="img img-responsive" style="" title="google">
                        </span> 
                    </a>
                </div>
